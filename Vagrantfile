...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mksadmin-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/wu"
  #   chef.validation_client_name = "wu-validator"
  #   chef.validation_key_path = ".chef/wu-validator.pem"
  # end
end
